  ...
  const topRatedMentors = [
    {
      ...
      university: "Dlkjdkd",
      location: "Here",
      bio: "Go dkdk d kdkd th o dlkd tktkt sisi ltktkt sisi sisi lkdkd deep ghdk dsoos dkdkd dkdk sllsdkd dkdkd dkkd dlskd dlkdkdl dkdldkd kldkdld lkd lkdldk dldkld dlkdkd ldkdkd ld dlkdld dldl dl",
      skillsToTeach: ["hjbjkkj"],
      skillsToLearn: ["gjhhjhjjj"],
    ...
    },
    {
      ...
      location: "dire dawa,",
      bio: "i love technology AND YES AYYH YESH  HI HI HI HI HI HIHIHI HIHIHI HIHIHI HIHIHIHIHIHIHI HIHIHI HIHIHIHIHIJ HIHIHIHI HI HI",
    ...
    },
    {
      ...
      bio: "passionate about technology and web development, a typescript enthusiast software engineering student and an orthodox christian",
      skillsToTeach: [
        "Javascipt",
        "C plus plus",
        "oop",
      ...
      skillsToLearn: ["Python", "cooking", "PHP", "speaking"],
